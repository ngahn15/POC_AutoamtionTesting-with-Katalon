...
WebUI.callTestCase(findTestCase('Katalon-keyword/Advance/PageObjects/HomePage/Open the Create Chat Channel form'), [:], FailureHandling.STOP_ON_FAILURE)

String nameChannel = "test_" + new Date().getDateTimeString()
